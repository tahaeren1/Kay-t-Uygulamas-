            ...
            <form>
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <textarea id="message" rows="3" class="form-control" v-model="userData.massage"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
      ...
      <div class="col-md-6" v-if="isSubmitted">
          <div class="panel panel-info">
            ...
            <div class="panel-body">
              ...
              <p style="white-space: pre">Açıklama: {{userData.massage}} </p>
  ...
  export default {
    ...
    data() {
      ...
      userData : {
        ...
        interests : [],
        gender : '',
        cities : ["İstanbul", "Ankara", "Ankara", "İzmir", "Bursa", "Konya", "Trabzon"],
        selectedCity : ''
      },
        switched : true,
        isSubmitted : false
